...
assert.match(hub, /<h1>Maaş ve Tazminat Hesaplama Araçları<\/h1>/, 'Hub H1 eksik');
...
console.log(`Hesaplayıcı keşif mimarisi doğrulandı: hub + ana sayfa + header + ${contextual} bağlamsal otorite sayfası.`);
