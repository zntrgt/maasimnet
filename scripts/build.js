...
await addCoreBlogCluster(distDir);
await addBenefitsBlogCluster(distDir);
await ensureBlogIndex(distDir);
await ensureBlogBreadcrumbSchema(distDir);
...
const version = { version: '0.7.1-seo-geo-content-clusters', builtAt: new Date().toISOString(), calculationEngine: 'central-kurus-engine' };
