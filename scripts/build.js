...
import { renderBonusScenario } from './render-bonus-scenario.js';
...
import { applyHomeResultState } from './apply-home-result-state.js';
...
await renderBonusScenario(distDir);
...
await applyHomeResultState(distDir);
