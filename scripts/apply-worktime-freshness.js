...
export async function applyWorktimeFreshness(dist) {
  for (const route of ROUTES) {
    ...
    const block = `<aside class="worktime-section" ${MARKER} aria-label="Güncellik bilgisi"><h2>Güncellik</h2><p>2026 bordro ve SGK parametreleri <strong>${DATA_2026.checkedAt}</strong> tarihinde resmî kaynaklarla kontrol edildi. Hesaplamalar kuruş bazlı merkezi bordro motoruyla yapılır.</p></aside>`;
